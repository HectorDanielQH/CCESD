...
import { obtenerHospitalPageRequest } from "../../api/hospitales";
...
export default function Hospitales(){
    ...
    useEffect(()=>{
        async function hospitalesGet() {
            const r=await obtenerHospitalPageRequest();
    ...
    const filtrar=(e)=>{
        ...
        const hospitalesFiltrados = hospitales.filter(hospital => {
          return hospital.hospital.toUpperCase().includes(filtro);
        });
        setFiltro(hospitalesFiltrados);
    }
    ...
    <div>
        ...
        <div className="flex flex-col justify-center items-center">
            <div className="mt-20 lg:mt-28 mb-10">
                <Typography variant="h1" className="sm:text-2xl md:text-3xl lg:text-4xl sm:text-center sm:mt-4 md:mt-10 text-blue-gray-500">LISTA DE HOSPITALES EN LA CIUDAD DE POTOSÍ</Typography>
            </div>
            <div className="w-9/12 sm:flex-col lg:flex-row flex justify-center items-center gap-2 sm:mb-6 md:mb-5">
                <h2 className="text-blue-gray-700 text-right lg:mr-5">
                    <strong>
                        Realiza la busqueda por hospital
                    </strong>
                </h2>
                <Input
                    type="search"
                            ...
                            <CardBody>
                                ...
                                <Accordion open={open === index+1}>
                                    ...
                                    <AccordionBody>
                                        <Chip
                                            color="amber"
                                            value={"TURNO MAÑANA: "+horariosvisita.turnomañana}
                                        />
                                        <br />
                                        <Chip
                                            color="teal"
                                            value={"TURNO TARDE: "+horariosvisita.turnotarde}
                                        />
                                    </AccordionBody>
                                </Accordion>
                                <Accordion open={open === index+1}>
