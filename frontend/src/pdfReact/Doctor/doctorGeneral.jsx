...
export default function PDFGeneral(props){
        ...
        <Document>
            <Page size={"letter"} style={styles.page}>
                ...
                <View style={styles.fila}>
                    ...
                    <Text style={styles.nombrecelda2}>Nombre Paciente</Text>
                    ...
                    props.objetos && props.objetos.length > 0 ? (
                        props.objetos.map((receta, index) => (
                            <View key={index.toString()} style={styles.filatabla}>
                                ...
                                <Text style={styles.nombreceldatabla2}>{receta.nombrePaciente}</Text>
